    ...
    <div className="w-full min-h-screen flex justify-center items-center">
      <form className="bg-white min-w-[70%] p-10 rounded-2xl flex flex-col justify-center items-center gap-0.5 max-w-md mx-4">
        ...
        <div className="flex items-center justify-center gap-8 py-2">
          <button
            className="flex cursor-pointer justify-center bg-terracota p-2 rounded-full hover:-translate-y-1 hover:scale-105 transition-all ease-linear duration-150 text-white text-[22px]"
            type="button"
          >
            <FaGoogle />
          </button>
          <button
            className="bg-terracota cursor-pointer p-2 rounded-full hover:-translate-y-1 hover:scale-105 transition-all ease-linear duration-150"
            type="button"
          >
            <img
              src={iconFacebook}
